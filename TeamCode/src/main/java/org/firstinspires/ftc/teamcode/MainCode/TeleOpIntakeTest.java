...
public class TeleOpIntakeTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        intakeServoPos = 0.0;
        intakeServo1.setPosition(intakeServoPos);
        intakeServo2.setPosition(intakeServoPos);
        ...
        while (opModeIsActive()) {
            ...
            boolean retractionAllowed = intakeServo1.getPosition() < 0.01 && intakeServo2.getPosition() < 0.01;
            if (gamepad2.y) {
                intakePower = 0;
                if (retractionAllowed)intakeServoPos = 0.4;
